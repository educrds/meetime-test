...
export class EntityInputComponent {
  protected entityStateService = inject(EntityStateService);
  protected entityValue = this.entityStateService.entityValue;
  ...
  */
  protected updateEntityValue(newValue: number) {
    this.entityStateService.updateEntityValue(newValue);
  }
}
